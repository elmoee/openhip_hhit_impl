...
#include "XKCP/KeccakSponge.h"
    ...
    #include "XKCP/displayIntermediateValues.h"
#endif

#ifdef XKCP_has_KeccakP200
    #include "XKCP/KeccakP-200-SnP.h"
    ...
    #include "XKCP/KeccakP-400-SnP.h"
    ...
    #include "XKCP/KeccakP-800-SnP.h"
